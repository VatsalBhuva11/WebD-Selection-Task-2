...
router.get("/home", authenticateToken, (req, res) => {
  ...
  router.post("/:username/:postID/like", authenticateToken, (req, res) => {
  ...
  router.post("/:username/:postID/dislike", authenticateToken, (req, res) => {
    const username = req.params.username; //the username of the user who's post is to be liked
    const postID = req.params.postID;
    if (username === req.username) {
      //req.username is the username of the authenticated user (the user who wants to like the post)
  ...
  router.post("/:username/:postID/comment", authenticateToken, (req, res) => {
